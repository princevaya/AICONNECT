...
import { removeOwnerOrAdmin } from "@/services/external-chat/chat.service";
...
export async function POST(
  ...
  try {
    ...
    await removeOwnerOrAdmin(roomCode, user);
    ...
    return toError(error, "Failed to remove from leadership", status);
  }
}
