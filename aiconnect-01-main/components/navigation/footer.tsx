                ...
                <AnimationContainer delay={0.1}>
                    <div className="flex flex-col items-start justify-start md:max-w-[200px]">
                        ...
                        <p className="text-muted-foreground mt-4 text-sm text-start">
                            AIConnect is your ultimate AI-powered recruitment platform, designed to streamline hiring and connect you with top talent effortlessly.
                        </p>
                    </div>
                </AnimationContainer>
            ...
            <div className="mt-8 border-t border-border/40 pt-4 md:pt-8 md:flex md:items-center md:justify-between w-full">
                <AnimationContainer delay={0.6}>
                    <p className="text-sm text-muted-foreground mt-8 md:mt-0">
                        &copy; {new Date().getFullYear()} AIConnect INC. All rights reserved.
                    </p>
                </AnimationContainer>
            </div>

            <div className="h-80 lg:h-80 hidden md:flex items-center w-full justify-center">
                <TextHoverEffect text="AIConnect" />
            </div>
        </footer>
    )
}
