        ...
        <div className="flex flex-col items-center justify-center w-full text-center bg-linear-to-t from-background">
          <AnimationContainer className="flex flex-col items-center justify-center w-full text-center">
            <button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
              ...
              <span className="backdrop absolute inset-px rounded-full bg-card transition-colors duration-200 group-hover:bg-popover" />
              <span className="h-full w-full blur-md absolute bottom-0 inset-x-0 bg-linear-to-tr from-primary/20"></span>
              <span className="z-10 py-0.5 text-sm text-card-foreground flex items-center justify-center gap-1">
                ✨ Advanced AI
        ...
        <AnimationContainer delay={0.1}>
          <div className="flex flex-col w-full items-center lg:items-center justify-center py-8">
            ...
            <h2 className="text-center lg:text-center text-3xl md:text-5xl leading-[1.1]! font-medium font-heading text-foreground mt-6">
              AIConnect offers everything you need to streamline your hiring
              process
            </h2>
            <p className="mt-4 text-center lg:text-center text-lg text-muted-foreground max-w-lg">
              AIConnect is your ultimate AI-powered recruitment platform,
              designed to streamline hiring and connect you with top talent
              effortlessly.
            </p>
          </div>
        </AnimationContainer>
      ...
      <MaxWidthWrapper className="py-10">
        <AnimationContainer delay={0.1}>
          <div className="flex flex-col items-center lg:items-center justify-center w-full py-8 max-w-xl mx-auto">
            ...
            <h2 className="text-center lg:text-center text-3xl md:text-5xl leading-[1.1]! font-medium font-heading text-foreground mt-6">
              How to get started with AIConnect
            </h2>
            <p className="mt-4 text-center lg:text-center text-lg text-muted-foreground max-w-lg">
              Getting started with AIConnect is easy. Follow these simple steps
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full py-8 gap-4 md:gap-8">
          {PROCESS.map((process, id) => (
            <AnimationContainer delay={0.2 * id} key={id}>
              <MagicCard className="group md:py-8 rounded-2xl">
      ...
      <MaxWidthWrapper className="py-10">
        <AnimationContainer delay={0.1}>
          <div className="flex flex-col items-center lg:items-center justify-center w-full py-8 max-w-xl mx-auto">
            ...
            <p className="mt-4 text-center lg:text-center text-lg text-muted-foreground max-w-lg">
              Transparent pricing with no hidden fees. Upgrade or downgrade
              ...
              <AnimationContainer delay={0.2 * index} key={index}>
                <MagicCard key={index} className="md:p-0">
                  <Card className="flex flex-col w-full border-none h-min bg-transparent">
                    {" "}
                    <CardHeader className="space-y-0 bg-transparent">
                      {" "}
                    ...
                    <CardContent className="space-y-4 pb-4 bg-transparent">
                      {" "}
                      <p className="text-muted-foreground">{review.review}</p>
                    </CardContent>
                    <CardFooter className="w-full space-x-1 mt-auto bg-transparent">
                      {" "}
          ...
          <LampContainer>
            <div className="flex flex-col items-center justify-center relative w-full text-center">
              ...
              <p className="text-muted-foreground mt-6 max-w-md mx-auto">
                Get started with AIConnect today and discover the power of
