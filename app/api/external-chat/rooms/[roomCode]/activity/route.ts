...
import { getActivityLogs } from "@/services/external-chat/chat.service";
...
export async function GET(
  ...
  try {
    ...
    const logs = await getActivityLogs(roomCode, user, limit);
    ...
    return toError(error, "Failed to load activity logs", status);
  }
}
